...
function updateUI() {
    ...
    if (spinBtn) spinBtn.disabled = isSpinning || currentBet.amount === 0 || inStreak || currentBet.amount > currentBalance;
...
function setupEventListeners() {
    ...
    document.querySelectorAll('.bet-spot').forEach(spot => {
        spot.addEventListener('click', () => {
            ...
            if (currentBet.color && currentBet.color !== color) currentBet.amount = 0;
...
// 🧪 Sélection pondérée en faveur de la couleur misée si potion active
